...
function init() {
  ...
  var getGroundTexture = function(w,h) {
  ...
  ground.position.set(0, controlAttr.groundPosY, 0);
  ...
  light4 = new THREE.PointLight( 0x808080, controlAttr.intensityLight4, 1000 );
  ...
  var getStarsTexture2 = function() {
    var g = p5.createGraphics();
    var texture = new THREE.Texture(canvas);
    texture.needsUpdate = true;
    return texture;
  }
